...
Carpeta= 'Ensayo Rel_Remoto_6_NN'                                                                                   # En esta carpeta se van a descargar los archivos Comtrade que se generan en el rel�
...
ScopeViewApi.setTrig(False)                                                                         # Desactiva el "Trigger" para que al momento de simular, no ejecute algu�n evento configurado
...
""" Loop para inyectar cada caso de prueba de líneas. Se leen los parámetros de cada caso y asignan 
a las líneas, inyecta con SV y regresa al estado estacionario inicial """
...
#for caso in range( 3 ):
    ...
    HyWorksApi.setComponentParameter( 'CP1', 'EnaGen', '1' )                                                    # Habilita los eventos definidos en la línea "CP1" 
    HyWorksApi.setComponentParameter( 'CP3', 'EnaGen', '0' )                                                    # Deshabilita los eventos definidos en la línea "CP3"
    ...
    ScopeViewApi.setTrig(True)                                                                              # Habilita el "Trigger" para captura de se�ales
    ...
    HyWorksApi.loadSnapshot()                                                                               # Carga el snapshot tomado anteriormente para volver a las "condiciones iniciales" de simulaci�n
    ScopeViewApi.setTrig(False)                                                                             # Deshabilita el Trigger para �nicamente hacer una captura de se�ales
...
print('Fin del set de pruebas en l�neas')


HyWorksApi.setComponentParameter( 'CP1', 'EnaGen', '0' )                # Se apagan ambas l�neas para q no entren en las fallas de las barras
HyWorksApi.setComponentParameter( 'CP3', 'EnaGen', '0' )

# Loop para inyectar cada caso de prueba de barras. Se leen los par�metros de cada caso y asignan a las barras, inyecta con SV y regresa al estado estacionario inicial
...
#---- Inicia código para analizar los archivos comtrade y entrenar el Decision Tree -----#

# Pausa para descargar los Comtrades la carpeta especificada y presionar 'Enter' para continuar la ejecución del código
...
# Busca en la carpeta "path2" todos los archivos con extensión '.cfg' y crea una lista con los nombres y otra con el directorio completo
...
Ress2= Re2[:] 
for ii,k in enumerate( DD ):                                                                # Se compara el vector de digitales que se captura de los comtrades con el vector de digitales que el DecisionTree asocia para el caso, con el fin de ver si el caso seleccionado s� es el correcto
